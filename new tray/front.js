...
$("#new").replaceWith( '<p style="background-color: #cee5ff; width: 100%; float:"right" class="form-control border-1 px-5 py-5" rows="10"> '+obj1[p].info+':</p>') 

//$("#new").replaceWith( '<p style="background-color: #eff7ff;> '+obj1[p].ville+'</p>')
